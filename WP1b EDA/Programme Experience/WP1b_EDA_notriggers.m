...
%                 Reward1 = round(Contrib(itrial).Xaxe,2) ;
%                 Reward2 = round(Contrib(itrial).Yaxe,2);      
            Reward1 = 0.50;
            Reward2 = 0.50;
...
%                 Reward1 = round(Contrib(itrial).Yaxe,2);
%                 Reward2 = round(Contrib(itrial).Xaxe,2);        
            Reward1 = 0.50;
            Reward2 = 0.50;
...
%             Reward1 = round(trials.randomReward1(itrial),2);
%             Reward2 = round((1 - trials.randomReward1(itrial)),2);
            Reward1 = 0.50;
            Reward2 = 0.50;
