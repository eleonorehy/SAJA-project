...
addpath('/Users/agencyteam/Desktop/SLB IJN/WP1a original/Training/Function');
PsychDefaultSetup(2);
...
%%%% breaks and feedback            
      ...
      if itrial == 16 % | itrial == 48 | itrial == 72 | itrial == 96 | itrial == 120 | itrial == 144 | itrial == 168 | itrial == 192 | itrial == 216 | itrial == 240 | itrial == 264 | itrial == 288
...
%         Screen('Flip', expWindow);
%         passKey(Key.space);
        DrawFormattedText(expWindow, ['Vous gagnez ' num2str(succeedTrials) '/16 points pour ce block.\n \nAppuyer sur espace pour quitter'], 'center', 'center', white);            
        Screen('Flip', expWindow);
        passKey(Key.space);
