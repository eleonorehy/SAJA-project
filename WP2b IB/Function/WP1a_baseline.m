...
%For the delays before flash
%timing1 = repmat([200, 300, 400, 500]', [12,1]);
%Timing1 = randperm(size(timing1, 1));
%what.randomDel =timing1(Timing1)*10^-3;
