...
mat0 = repmat(X0,[(2/9)*NumberOfBloc,1]); %gives 288 trials with 9 Blocks

catcht = ones(32*NumberOfBloc,1);
mat0(:, 6) = catcht;
...
position1 = repmat(position1, [3*NumberOfBloc,1]); % 3*4*3*NumberOfBloc = ntrials
               
%position of gain 2 (matrix 2 & matrix 3) % decisional noise
position2 = [2;3;4;1;3;4;1;2;4;1;2;3];
position2 = repmat(position2, [3*NumberOfBloc,1]); % 3*4*3*NumberOfBloc = ntrials
