...
try
    ...
    while trial < numberOfTrials+1 
        ...
        while exitSelfReport == false
            ...
            Screen('TextSize', expWindow, 30);
            if agent == 1 && trial == 1
            selfLine1 = 'How much did your left hand contribute?';
            elseif agent == 1 && trial == 2
            selfLine1 = 'How much did your right hand contribute?';
            elseif agent == 2 && trial == 3
            selfLine1 = 'How much did you contribute?';
            elseif agent == 2 && trial == 4
            selfLine1 = 'How much did the co-actor contribute?';   
            end
            DrawFormattedText(expWindow, selfLine1, 'center',Info.rect(4)*0.2, white);
            Screen('TextSize', expWindow, 25);
            
            for number = 1:9
            DrawFormattedText(expWindow, num2str(NumbreScale(number)),Info.rect(3)*PlaceNumber(number),Info.rect(4)*0.4+15,white);
            Screen('DrawLine', expWindow, white, Info.rect(3)*PlaceNumber(number), Info.rect(4)*0.4-7, Info.rect(3)*PlaceNumber(number), Info.rect(4)*0.4+7,4);
            DrawFormattedText(expWindow, num2str(NumbreScale(number)),Info.rect(3)*PlaceNumber(number),Info.rect(4)*0.8+15,white);
            Screen('DrawLine', expWindow, white, Info.rect(3)*PlaceNumber(number), Info.rect(4)*0.8-7, Info.rect(3)*PlaceNumber(number), Info.rect(4)*0.8+7,4);
