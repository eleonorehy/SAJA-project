...
%             [allRects, square] = DrawTheSquares(baseRect, Info, nXi);  
            ...
            if Sujet1 == 0 % sujet1 controls Xaxis and sujet2 controls Yaxis & noise on the non-controlled axis
                ...
                if keyCodeSujet1(Key.left)
                 ...
                 elseif keyCodeSujet1(Key.right)
                    dot.Xpos = dot.Xpos + pixelsPerPressDot ;
                    dot.Ypos = dot.Ypos + (actualNoise * trials.signe(itrial)) ;
                    upKP = upKP + 0;
                    downKP = downKP + 0;
                ...
                elseif keyCodeSujet1(Key.up)
                    dot.Ypos = dot.Ypos;
                
                elseif keyCodeSujet1(Key.down)
                    dot.Ypos = dot.Ypos;
                          
            
                elseif keyCodeSujet2(Key.up)
                ...
                elseif keyCodeSujet2(Key.left)
                    dot.Xpos = dot.Xpos;
                
                elseif keyCodeSujet2(Key.right)
                    dot.Xpos = dot.Xpos;
                ...
                if rightKP == 1 & upKP == 1
                    dot.Xpos = dot.Xpos;
                    dot.Ypos = dot.Ypos;
                elseif rightKP == 1 & downKP == 1
                    dot.Xpos = dot.Xpos;
                    dot.Ypos = dot.Ypos;
                elseif leftKP == 1 & upKP == 1
                    dot.Xpos = dot.Xpos;
                    dot.Ypos = dot.Ypos;
                elseif leftKP == 1 & downKP == 1
                    dot.Xpos = dot.Xpos;
                    dot.Ypos = dot.Ypos;
                end 
...
%             Reward2block = 0;
    ...
    Screen('DrawLine', expWindow, white, Info.xC, 0, Info.xC, Info.rect(4),2);
    Screen('TextSize', expWindow, 30);   
    DrawFormattedText(expWindow, ['Merci de votre participation \n \n Player1 a gagne :' '\n \n' num2str(Cagnotte1) ' euros'], 'center', 'center', white, [], [], [], [], [],[Info.rect(1) Info.rect(2) Info.xC, Info.rect(4)]);
    DrawFormattedText(expWindow, ['Merci de votre participation \n \n Player2 a gagne :' '\n \n' num2str(Cagnotte2) ' euros'], 'center', 'center', white, [], [], [], [], [], [Info.xC Info.rect(2) Info.rect(3), Info.rect(4)]);
    Screen('Flip', expWindow);
    passKey(Key.space);
